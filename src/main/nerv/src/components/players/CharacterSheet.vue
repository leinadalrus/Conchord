...
const useCharacterSheetStore = defineStore("player", () => {
  ...
  function getID(characterID: number): number {
...
<template>
  <article v-show="useCharacterSheetStore.getID(1)">
    <img :src="useCharacterSheetStore.getImage('public/user/avatars/**')" alt="" />
    <p>{{ useCharacterSheetStore.getName("John Doe") }}</p>
  </article>
</template>
